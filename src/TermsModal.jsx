...
const TermsModal = () => {
  return (
    <div className="text-gray-700 text-sm space-y-4">
      ...
      <p>
        By accessing or using AIDT&D's AI, ML, and RPA training services, you agree to comply with these Terms of Service. These terms govern your participation in our programs, internships, and use of any related technologies.
      </p>
      ...
      <p>
        All AI models, automation scripts, and training materials provided by AIDT&D remain our intellectual property. Students and interns may use these solely for educational purposes during the program.
      </p>
      ...
      <p>
        AIDT&D shall not be liable for any outcomes resulting from the implementation of AI/ML/RPA solutions developed during our programs. Students and partners implement solutions at their own risk.
      </p>
