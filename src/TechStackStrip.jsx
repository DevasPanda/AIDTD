...
const TECH_STACK = [
  ...
  { name: "ABBYY Vantage", short: "ABBYY Vantage", src: "/logos/abbyy.svg" },
  { name: "Python", short: "Python", src: "/logos/python.svg" },
  { name: "Node.js", short: "Node.js", src: "/logos/node.svg" },
  { name: "React + Vite", short: "React/Vite", src: "/logos/react.svg" },
...
export default function TechStackStrip() {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="tech-marquee rounded-3xl border border-white/10 bg-slate-900/70 backdrop-blur">
          <div className="tech-marquee-track">
            {LOOP_STACK.map((tech, idx) => (
              <div key={idx} className="tech-logo-card flex flex-col items-center justify-center gap-2">
  {tech.src ? (
  ...
  {/* Label under logo */}
  <span className="tech-logo-label">
    {tech.name}
  </span>
</div>
